...
# Register instance (allow to fail if RabbitMQ is not ready)
echo "Registering instance..."
python manage.py register_instance "$MACHINE_SIGNATURE" || echo "Warning: Instance registration failed, continuing anyway..."

# Load the configuration variable
echo "Configuring instance..."
python manage.py configure_instance || echo "Warning: Instance configuration failed, continuing anyway..."

# Create the default bucket
echo "Creating default bucket..."
python manage.py create_bucket || echo "Warning: Bucket creation failed, continuing anyway..."

# Clear Cache before starting to remove stale values
echo "Clearing cache..."
python manage.py clear_cache || echo "Warning: Cache clear failed, continuing anyway..."
